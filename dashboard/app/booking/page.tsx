...
const Booking = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.HOST}/server/event/tickets/${eventid}`)
            .then(res => {
                setTickets(res.data)
            })
    ...
    const displayRazorpay = async (purchaseamount: number) => {
        ...
        const result = await axios.post(`${process.env.HOST}/server/event/razorpay-payment`, {
            amt: purchaseamount
        });
        ...
        const options = {
            ...
            handler: async function (response: any) {
                ...
                const result = await axios.post(`${process.env.HOST}/server/event/razorpay-success`, data);
                if (result) {
                    ...
                    axios.post(`${process.env.HOST}/server/event/order/post`, purchaseOrders)
                        .then(data => {
                            console.log(data);
    ...
    return (
        <div className='h-screen w-full'>
            ...
            <div
                ...
                <Image alt="Event Image" className='mx-auto my-5 rounded-xl' src={`${process.env.HOST}/server/images/${event?.imageLoc}`} width={120} height={120} />
